      ...
      <div class="row">
        <div class="col">
          <input :value="estado.tarefaTemp" @change="evento => estado.tarefaTemp = evento.target.value" required
            type="text" placeholder="Digite aqui a descrição" class="form-control">
        </div>
        <div class="col-md-1">
        ...
        <div class="col-md-2">
          <select @change="evento => estado.filtro = evento.target.value" class="form-control">
            <option value="todas" class="todas">Todas tarefas</option>
            <option value="Pendentes" class="todas">Pendentes</option>
            <option value="Finalizadas" class="todas">Finalizadas</option>
          </select>
        </div>
      </div>
    </form>
